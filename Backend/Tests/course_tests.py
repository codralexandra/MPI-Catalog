...
class TeacherCourseTests(unittest.TestCase):
    ...
    def test_add_assignment(self):
        """Test adding an assignment for a course."""
        course_id = '67e29e50900069427cc4c359'
        ...
        assignment_id = response.get_data(as_text=True)
        self.assertEqual(response.status_code, 200)

        delete_response = self.client.delete('/course/teacher/remove-assignment', data={
            'course_id': course_id,
